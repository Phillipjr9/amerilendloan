...
const testimonials = [
  { name: "Sarah M.", location: "Austin, TX", rating: 5, text: "AmeriLend saved me when I needed emergency car repairs. I paid the 3.5% processing fee with my credit card and got my loan the next day!" },
  ...
  { name: "Maria G.", location: "Miami, FL", rating: 5, text: "I was worried about my credit score, but AmeriLend worked with me. The 3.5% processing fee paid upfront is worth it for the fast disbursement!" },
  ...
  { name: "Robert H.", location: "Denver, CO", rating: 5, text: "I've used other lenders before, but AmeriLend is by far the best. Paid 3.5% processing fee upfront via card - very straightforward!" },
  ...
  { name: "Christopher B.", location: "Boston, MA", rating: 5, text: "Quick turnaround time and competitive rates. Paid the 3.5% processing fee with my Visa card before disbursement - complete transparency!" },
  ...
  { name: "Jessica F.", location: "Nashville, TN", rating: 5, text: "Great experience from start to finish. The loan officer explained the 3.5% processing fee payment options clearly - I paid via Mastercard!" },
  ...
  { name: "Brian M.", location: "San Antonio, TX", rating: 5, text: "Straightforward process with no surprises. The 3.5% processing fee is paid upfront via card or crypto - everything was exactly as promised!" },
  ...
  { name: "Steven E.", location: "Indianapolis, IN", rating: 5, text: "Great communication throughout the entire process. Paid 3.5% processing fee via USDT before disbursement - one of the lowest I've seen!" },
  { name: "Kimberly R.", location: "Sacramento, CA", rating: 5, text: "The best part? No prepayment penalties! Just pay the 3.5% processing fee upfront via card, then I can pay off my loan early without extra fees!" },
  { name: "Joseph L.", location: "Kansas City, MO", rating: 5, text: "Needed money for home repairs and AmeriLend came through. Paid 3.5% processing fee via debit card before disbursement - simple and fast!" },
  ...
  { name: "Melissa H.", location: "Albuquerque, NM", rating: 5, text: "The transparency is what I appreciate most. Just a 3.5% processing fee paid upfront via card before disbursement - no hidden charges whatsoever!" },
  ...
  { name: "Laura P.", location: "Oklahoma City, OK", rating: 5, text: "Fast, efficient, and professional service. Paid the 3.5% processing fee via American Express before disbursement - everything I needed!" },
